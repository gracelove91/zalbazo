...
Insert into ZALBAZO.ZALBAZO_USER (USER_EMAIL, PASSWORD, ROLE, TEL, ADDRESS, NAME, JOIN_DATE, LAST_LOGIN) Values('dummy@gmail.com', '{noop}1234', 'user', '01033499440', '서울시 서초구', '홍길동', sysdate, null);
...
values (CONTENT_SEQ.nextval, '우리 집 어르신 뽀삐(10세)도 만족해하더군요,, 잊지 말자 돌봄 동물병원,,,', sysdate, 3, 'dummy@gmail.com')
