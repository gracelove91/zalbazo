...
values ('upwyy123@gmail.com','{noop}1234','user','444','서울특별시 동작구 동작대로 121-4,(사당동)','메메',to_date('19/10/14','RR/MM/DD'),null,'enabled',null,null);
...
values ('doglover@daum.net', '{noop}1234', 'user', 01045671234, '서울 서초구 방배로33길 29', '박수진', sysdate, null, null, 'enabled');
insert into ZALBAZO_USER (USER_EMAIL, PASSWORD, ROLE, TEL, ADDRESS, NAME, JOIN_DATE, LAST_LOGIN, HOSPITAL_ID, ENABLED)
values ('ilikecat@gmail.com', '{noop}1234', 'user', 01012347890, '경기 오산시 삼미로 34', '한성진', sysdate, null, null, 'enabled');
insert into ZALBAZO_USER (USER_EMAIL, PASSWORD, ROLE, TEL, ADDRESS, NAME, JOIN_DATE, LAST_LOGIN, HOSPITAL_ID, ENABLED)
values ('bird1234@daum.net', '{noop}1234', 'user', 01011119923, '부산 해운대구 마린시티2로 33', 'jin', sysdate, null, null, 'enabled');
insert into ZALBAZO_USER (USER_EMAIL, PASSWORD, ROLE, TEL, ADDRESS, NAME, JOIN_DATE, LAST_LOGIN, HOSPITAL_ID, ENABLED)
values ('puppylover@naver.com', '{noop}1234', 'user', 01045671234, '세종특별자치시 다정남로 22', 'mike', sysdate, null, null, 'enabled');
insert into ZALBAZO_USER (USER_EMAIL, PASSWORD, ROLE, TEL, ADDRESS, NAME, JOIN_DATE, LAST_LOGIN, HOSPITAL_ID, ENABLED)
...
values (CONTENT_SEQ.nextval,
        '우리 집 어르신 뽀삐(10세)도 만족해하더군요,, 잊지 말자 돌봄 동물병원,,,', sysdate, 3, 'iceice@gmail.com')
...
Insert into ZALBAZO.CONTENT (CONTENT_ID,TITLE,BODY,CREATED_DATE,CATEGORY_ID,USER_EMAIL) 
values (CONTENT_SEQ.nextval,'강아지가 너무 몸을 긁어요','강아지가 저번주부터 몸을 너무 긁는데 병원에 데려가야 할까요?',sysdate,2,'doglover@daum.net');
Insert into ZALBAZO.CONTENT (CONTENT_ID,TITLE,BODY,CREATED_DATE,CATEGORY_ID,USER_EMAIL) 
values (CONTENT_SEQ.nextval,'아이를 분양보냈어요','너무너무 허전하네요
잘바조 회원님들은 이런 상황을 어떻게 극복하시나요?',sysdate,1,'ilikecat@gmail.com');
Insert into ZALBAZO.CONTENT (CONTENT_ID,TITLE,BODY,CREATED_DATE,CATEGORY_ID,USER_EMAIL) 
values (CONTENT_SEQ.nextval,'고양이가 좋아하는 음식은?','곧 아는 사람한테 고양이를 받게 되는데
고양이 사료만 챙겨주면 되나요? 간식도 따로 챙겨줘야 하나요?',sysdate,2,'ilikecat@gmail.com');
Insert into ZALBAZO.CONTENT (CONTENT_ID,TITLE,BODY,CREATED_DATE,CATEGORY_ID,USER_EMAIL) 
values (CONTENT_SEQ.nextval,'왕관앵무 키우고 싶은데 많이 비싼가요?','남들과 다른 동물을 키워보고 싶어서 왕관앵무에 관심이 생겼는데
많이 비싼가요? 그리고 어디서 데려와야 하나요? ',sysdate,2,'bird1234@daum.net');
Insert into ZALBAZO.CONTENT (CONTENT_ID,TITLE,BODY,CREATED_DATE,CATEGORY_ID,USER_EMAIL) 
values (CONTENT_SEQ.nextval,'곧 왕관앵무를 만나요','정말 어렵게 어렵게 데려오네요,,
이제 곧 만나는데 너무 기대되요!
앞으로 자주 소식 올리겠습니다.',sysdate,1,'bird1234@daum.net');
Insert into ZALBAZO.CONTENT (CONTENT_ID,TITLE,BODY,CREATED_DATE,CATEGORY_ID,USER_EMAIL) 
values (CONTENT_SEQ.nextval,'비글이 정말 소문만큼 지랄견인가요?','생긴게 너무 제 스타일이라서 키우고 싶은데
마당도 없는 집인데 좀 걱정되긴 하네요.
정말 소문만큼 지랄견인가요? ',sysdate,2,'puppylover@naver.com');
Insert into ZALBAZO.CONTENT (CONTENT_ID,TITLE,BODY,CREATED_DATE,CATEGORY_ID,USER_EMAIL) 
...
Insert into ZALBAZO.ANIMAL (ANIMAL_ID,TYPE,SEX,WEIGHT,AGE,ANAME,NOTE,LAST_TREAT_DATE,CREATED_DATE,USER_EMAIL) 
values (ANIMAL_SEQ.nextval,'개','남',5,3,'실버','갈색푸들',to_date('19/10/16','RR/MM/DD'),sysdate,'puppylover@naver.com');
Insert into ZALBAZO.ANIMAL (ANIMAL_ID,TYPE,SEX,WEIGHT,AGE,ANAME,NOTE,LAST_TREAT_DATE,CREATED_DATE,USER_EMAIL) 
values (ANIMAL_SEQ.nextval,'패럿','남',2,1,'밍밍',null,to_date('19/10/16','RR/MM/DD'),sysdate,'nakta@daum.net');
Insert into ZALBAZO.ANIMAL (ANIMAL_ID,TYPE,SEX,WEIGHT,AGE,ANAME,NOTE,LAST_TREAT_DATE,CREATED_DATE,USER_EMAIL) 
values (ANIMAL_SEQ.nextval,'왕관앵무','여',2,3,'미미',null,to_date('19/10/16','RR/MM/DD'),sysdate,'bird1234@daum.net');
Insert into ZALBAZO.ANIMAL (ANIMAL_ID,TYPE,SEX,WEIGHT,AGE,ANAME,NOTE,LAST_TREAT_DATE,CREATED_DATE,USER_EMAIL) 
values (ANIMAL_SEQ.nextval,'고양이','여',5,2,'뚠뚠','길고양이 출신',to_date('19/10/16','RR/MM/DD'),sysdate,'ilikecat@gmail.com');
Insert into ZALBAZO.ANIMAL (ANIMAL_ID,TYPE,SEX,WEIGHT,AGE,ANAME,NOTE,LAST_TREAT_DATE,CREATED_DATE,USER_EMAIL) 
values (ANIMAL_SEQ.nextval,'개','중성',4,1,'쿠키','말티즈',to_date('19/10/16','RR/MM/DD'),sysdate,'doglover@daum.net');
...
Insert into ZALBAZO.RESERVE (RESERVE_ID,NOTE,RDATE,ANIMAL_ID,HOSPITAL_ID,STATUS,USER_EMAIL) 
values (RESERVE_SEQ.nextval,'요즘 힘이 없고 먹이를 잘 안먹어요',to_date('19/10/23','RR/MM/DD'),2,2,'진료 전','nakta@daum.net');
Insert into ZALBAZO.RESERVE (RESERVE_ID,NOTE,RDATE,ANIMAL_ID,HOSPITAL_ID,STATUS,USER_EMAIL) 
values (RESERVE_SEQ.nextval,'설사가 너무 심해요',to_date('19/11/01','RR/MM/DD'),1,1,'진료 전','puppylover@naver.com');
Insert into ZALBAZO.RESERVE (RESERVE_ID,NOTE,RDATE,ANIMAL_ID,HOSPITAL_ID,STATUS,USER_EMAIL) 
values (RESERVE_SEQ.nextval,'며칠 전부터 걸을 때 발을 절어요',to_date('19/10/18','RR/MM/DD'),3,3,'진료 전','bird1234@daum.net');
Insert into ZALBAZO.RESERVE (RESERVE_ID,NOTE,RDATE,ANIMAL_ID,HOSPITAL_ID,STATUS,USER_EMAIL) 
values (RESERVE_SEQ.nextval,'변에서 피가 나와요ㅠㅠ',to_date('19/10/22','RR/MM/DD'),4,1,'진료 전','ilikecat@gmail.com');
Insert into ZALBAZO.RESERVE (RESERVE_ID,NOTE,RDATE,ANIMAL_ID,HOSPITAL_ID,STATUS,USER_EMAIL) 
values (RESERVE_SEQ.nextval,'미용',to_date('19/10/31','RR/MM/DD'),5,1,'진료 전','doglover@daum.net');
