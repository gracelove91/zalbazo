...
Values('jjlee@gmail.com', '{noop}1234', 'user', '01097946214', '인천시 부평구', '이재이', sysdate, sysdate, 'enabled');
...
INSERT into animal(ANIMAL_ID, TYPE, SEX, WEIGHT, AGE, ANAME, NOTE, LAST_TREAT_DATE, CREATED_DATE, UPDATED_DATE, USER_EMAIL)
...
values (RESERVE_SEQ.nextval, '알레르기가 있어서 눈꼽이 계속 껴서 눈을 제대로 못 뜹니다.', sysdate, 2, 1, '진료 전', 'jjlee@gmail.com');