...
<p align="center" style="font-size:50px;color:black">반려동물이 아플 땐 <span style="color:#25CCF7; font-weight:bold;">잘바조</span></p>
...
<div class="row">
     <div class="col"></div> 
     <div class="col-8">
        <img style="max-width: 100%; height: auto;" src="${ctx}/resources/img/aboutus/aboutus.png">
     </div>
     <div class="col"></div> 
</div>
