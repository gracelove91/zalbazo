            ...
            <table class="table table-striped" style="max-width: 1080px;">
                ...
                <c:forEach items="${contentList}" var="content">
                    <tr>
                        ...
                        <td>
                            <a class='move' style="color : #000000;" href='<c:out value="${content.contentId}"/>'><c:out
                            ...
                            <div class="row d-flex d-md-block flex-nowrap wrapper">
                                <main id="main" class="col-md-9 float-left col pl-md-5 pt-3 main">
                                    ...
                                    <table class="table table-striped" style="max-width: 1080px;">
                                        <thead>
                                        <tr>
                                            <th scope="col" class="mobile" style="width:55px; text-align:center;">번호
                                            </th>
                                            <th scope="col" class="mobile" style="text-align:center;">제목</th>
                                            <th scope="col" class="mobile" style="width:80px; text-align:center;">작성자
                                            </th>
                                            <th scope="col" class="mobile" style="width:120px; text-align:center;">날짜
                                            </th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class='move' style="color: #000000;"
                                                       href='<c:out value="${content.id}"/>'><c:out
                                                            value="${content.title}"/></a>
                                                </td>
                                                ...
                                                <td class="mobile" style="text-align:center;">
                                                    <fmt:formatDate value="${content.createdDate}"
                                                                    pattern="yyyy-MM-dd"/>
                                                </td>
                                            </tr>
                                        </c:forEach>
                            ...
                            <div class="col-lg-12">
                                ...
                                <form id='searchForm' action="/community/list" method='get'>
                                    <select name='type'>
                                        ...
                                        <option value="B"<c:out
                                                value="${pageMaker.cri.type eq 'B' ? 'selected' : '' }"/>>내용
                                        </option>
                                        <option value="U"<c:out
                                                value="${pageMaker.cri.type eq 'U' ? 'selected' : '' }"/>>작성자
                                        </option>
                                        <option value="TB"<c:out
                                                value="${pageMaker.cri.type eq 'TB' ? 'selected' : '' }"/>>제목 or 내용
                                        </option>
                                        <option value="TU"<c:out
                                                value="${pageMaker.cri.type eq 'TU' ? 'selected' : '' }"/>>제목 or 작성자
                                        </option>
                                        <option value="TUB"<c:out
                                                value="${pageMaker.cri.type eq 'TUB' ? 'selected' : '' }"/>>제목 or 내용 or
                                            작성자
                                        </option>
                                    </select>
