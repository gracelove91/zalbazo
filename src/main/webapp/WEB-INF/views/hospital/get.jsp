...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-5"><br>
            ...
            <p class="h4">
                <i class="material-icons" style="font-weight:bold">my_location</i> <span
                    class="h6">&nbsp;&nbsp;${hospital.address}</span>
            </p>
            <p class="h4">
                <i class="material-icons" style="font-weight:bold">alarm</i>
                <span>&nbsp;&nbsp;${hospital.treatStart}</span>
            </p>
            <p class="h4">
                <i class="material-icons" style="font-weight:bold">alarm_off</i>
                <span>&nbsp;&nbsp;${hospital.treatEnd}</span>
            </p><br>
            <!-- 해당 병원에 맞는 라벨 출력 -->
        ...
        <div class="col-5">
            ...
            <p class="h5 heart" style="text-align: center">
                ...
                <i class="material-icons favorite" data-i="white" id=outlined
                   style="cursor: pointer;">favorite_border</i>즐겨찾기
            </p>
                                        ...
                                        <li class="left clearfix">
                                            <div class="container mt-3">
                                                ...
                                                <div class="container">
                                                    ...
                                                    <input type='hidden' class="form-control" name="hospitalId"
                                                           value="${hospital.hospitalId}">

                                                    <div class="form-group" style="border-width: 5px;">
                                                        <textarea class="form-control txt" rows="5" id="review"
                                                                  name="review" placeholder="리뷰를 남겨주세요"></textarea><br>
                                                        <div>
                                                            <div>
                                                                <i class="stars" style="color:gold;font-weight:bold;"
                                                                   name="stars">
                                                                    <i class='material-icons star' id="star1"
                                                                       name="star1" data-star="1">star_border</i>
                                                                    <i class='material-icons star' id="star2"
                                                                       name="star2" data-star="2">star_border</i>
                                                                    <i class='material-icons star' id="star3"
                                                                       name="star3" data-star="3">star_border</i>
                                                                    <i class='material-icons star' id="star4"
                                                                       name="star4" data-star="4">star_border</i>
                                                                    <i class='material-icons star' id="star5"
                                                                       name="star5" data-star="5">star_border</i>
                                                                </i>
                                                            </div>
                                                            <div align="right">
                                                                <button type="submit" class="btn btn-secondary"
                                                                        id="reviewBtn" name="reviewBtn">Submit
                                                                </button>
                                                            </div>
                                                        </div>
                                                    </div>
                                ...
                                <div class="panel-body">
                                    <div class="container mt-3">
                                        <div class="form-group">
                                            <textarea class="form-control txt" rows="5" id="body"
                                                      name="body"></textarea>
                                        </div>

                                        <button type="submit" class="btn btn-secondary float-right" id="regBtn"
                                                name="regBtn">Submit
                                        </button>
...
<script type="text/javascript"
        src="//dapi.kakao.com/v2/maps/sdk.js?appkey=5ea4ef47b16d9a398f9876fcc56c42fe&libraries=services"></script>
<script>
