		...
		<div class="container">
			...
			<ul class="nav nav-tabs" role="tablist">
				<li class="nav-item"><a class="nav-link active"
					data-toggle="tab" href="#home">Map</a></li>
						...
						<div class="col-lg-12">
							...
							<div class="panel panel-default">
								...
								<div class="panel-heading"
									style="padding-left: 20px; font-size: x-large;">
										...
										<li class="left clearfix">
											...
											<div class="container mt-3">
												...
												<div class="media border p-3"
													...
													<img src="/resources/img/baba.png"
											...
											<div class="container mt-3">
												...
												<div class="media border p-3">
													...
													<div class="media-body">
														...
														<h4>
															<i style="color: gold; font-weight: bold"> <i
				...
				<div id="menu2" class="container tab-pane fade">
					...
					<div class="info container">
						<input type="hidden" class="form-control" name="userEmail"
							value="dummy@gmail.com"> <input type='hidden'
