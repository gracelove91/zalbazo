...
<!-- FavoriteHospitalList의 class가 fav여야함 -->
			...
			<p class="h5 get" style="text-align: center">
				...
				<img class="favorite" data-i="white" id="outlined" style="cursor: pointer; vertical-align: text-bottom;" src="${ctx}/resources/img/pink_outlined_heart.png" width="43px" height="43px"> 즐겨찾기
			</p>
