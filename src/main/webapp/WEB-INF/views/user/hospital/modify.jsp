   ...
   <div class="row">
      ...
      <div id="main" class="col-md-8">
          ...
          <form class="pt-3 md-3" role='form' action="/hospitalinfo/modify" method="post" enctype="multipart/form-data">
            ...
            <button type="submit" class="btn btn-primary float-right" id="submitBtn" name="submitBtn">수정완료</button>
          </form>
          <br /><br /><br />
...
$(document).ready(function(){
	(function(){
		var userEmail = 'scienceos@naver.com';
